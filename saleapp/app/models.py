...
if __name__ == "__main__":
    with app.app_context():
        ...
        # db.create_all()
        # import hashlib
        # user = User(name="admin", avatar="https://res.cloudinary.com/dxxwcby8l/image/upload/v1647056401/ipmsmnxjydrhpo21xrd8.jpg",
        #             username="admin", password=str(hashlib.md5("123456".encode("utf-8")).hexdigest()), user_role=UserRole.ADMIN)
        # db.session.add(user)
        # db.session.commit()
